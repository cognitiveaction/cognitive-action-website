      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-32 text-center">
          ...
          >
            ...
            <h1 className="text-6xl font-bold tracking-tight text-[#1D1D1F] mb-6">
              Your Path to{" "}
      ...
      <section className="bg-[#F5F5F7] py-24">
        <div className="max-w-6xl mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#1D1D1F] mb-4">How We Work</h2>
            <p className="text-lg text-[#6E6E73]">A proven path from vision to value.</p>
          </AnimatedSection>

          <StaggerContainer className="flex flex-col md:flex-row items-start justify-between gap-4">
            {steps.map((step, i) => (
              <StaggerItem key={step} className="flex-1 text-center">
                <div className="w-10 h-10 rounded-full bg-[#0071E3] text-white flex items-center justify-center mx-auto mb-3 text-sm font-semibold">
                  {i + 1}
                </div>
